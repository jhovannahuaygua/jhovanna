...
public class Ejercicio2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Ejercicio2</title>");            
            out.println("</head>");
            out.println("<body>   <body bgcolor =\"lightcoral\">");
            out.println("<center><h1>Servlet Ejercicio2 </h1>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body> <body bgcolor =\"lightcoral\">");
            out.println("<center><h1>Cambio De Moneda</h1>");
           // String numCad = select+"";
            DecimalFormat f2 = new DecimalFormat("#.00");
            if (select == 1 ){
                out.println("<center><h1>Cambio a Dolares</h1><br>");
                cambioY = cambio1 / 6.98;
                out.println(""+ f2.format(cambioY) +"$us");    
            }
            if (select == 2) {
                out.println("<center><h1>Cambio a Bolivianos</h1><br>");
