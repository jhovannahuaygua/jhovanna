...
public class Ejercicio3 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>  <body bgcolor =\"olive\">");
            out.println("<center><h1>Servlet Ejercicio 3 </h1>");
            out.println("<center><h2>Operaciones Matematicas</h2>");
            out.println("<form action='' method='post'>");
            out.println("Introducir valor 1");
            out.println("<input type='text' name='numero1' required>");
            out.println("introducir valor 2");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<title>Servlet Ejercicio3</title>");            
            out.println("</head>");
            out.println("<body>  <body bgcolor =\"orange\">");
            out.println("<center><h1>Resultado</h1>");
