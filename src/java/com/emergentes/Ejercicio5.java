...
public class Ejercicio5 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            out.println("</head>");
            out.println("<body>  <body bgcolor =\"lightseagreen\">");
            out.println("<center><h1>Servlet Ejercicio 5 </h1>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int aux=1;
           ...
           try{
            ...
            out.println("<title>Servlet Ejercicio5</title>");            
            out.println("</head>");
            out.println("<body> <body bgcolor =\"yellowGreen\">");
            out.println("<center><h1>Servlet Ejercicio 5 </h1>");
            out.println("<center><h3>LLENADO DE MATRIZ0'P </h3>");
